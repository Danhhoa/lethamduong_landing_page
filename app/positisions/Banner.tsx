...
export const Banner = () => {
    return (
        <div className="flex lg:bg-[url('/backgrounds/banner-pc.png')] bg-[url('/backgrounds/banner-mobile.png')] bg-cover bg-bottom-center bg-no-repeat lg:p-20 md:pl-10 pl-5 lg:mt-20 mt-10 pb-28 min-h-[calc(100vh-80px)] lg:pt-0 md:pt-[700px] pt-[400px]">
