...
export const Banner = () => {
    return (
        <div className="flex lg:bg-[url('/backgrounds/banner-pc.webp')] bg-[url('/backgrounds/banner-mobile.webp')] bg-cover lg:bg-center bg-bottom-center  bg-no-repeat lg:p-20 md:pl-10 pl-5 lg:mt-20 mt-10 pb-28 min-h-[calc(100vh-80px)] lg:pt-0 md:pt-[700px] pt-[400px]">
            <div className="flex flex-col lg:basis-1/3 gap-3 mt-20">
                <h1 className="xl:text-[52px] lg:text-[46px] text-4xl text-[#1625AD] font-black leading-[67px] xl:min-w-[600px] lg:min-w-[480px] xl:mt-20 lg:mt-0 mt-10">
